...
router.get("/", authUser, authRole("user", "admin"), (req, res) => {
...
router.get("/pricing", authUser, authRole("user", "admin"), (req, res) => {
...
router.get("/logout", authUser, authRole("user", "admin"), (req, res) => {
